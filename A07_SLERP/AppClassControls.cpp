...
#pragma region Camera Positioning
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
		m_m4SunTranslate = glm::translate(m_m4SunTranslate, vector3(0.0f, 0.0f, fTranslate));

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::X))
		m_m4SunTranslate = glm::translate(m_m4SunTranslate, vector3(fTranslate, 0.0f, 0.0f));

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
		m_m4SunTranslate = glm::translate(m_m4SunTranslate, vector3(0.0f, fTranslate, 0.0f));
#pragma endregion
